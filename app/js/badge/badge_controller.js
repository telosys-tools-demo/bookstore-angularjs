 ...
 **/
badgeModule.controller('BadgeCtrl', ['Badge', '$scope', '$routeParams', '$http', '$location', '$cookies', 'MessageHandler', function(Badge, $scope, $routeParams, $http, $location, $cookies, MessageHandler) {
